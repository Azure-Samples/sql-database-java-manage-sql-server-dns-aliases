...
products:
- azure
description: "Azure SQL sample for managing SQL Server DNS Aliases."
urlFragment: sql-database-java-manage-sql-server-dns-aliases
---

# Manage SQL Server DNS Aliases (Java)
